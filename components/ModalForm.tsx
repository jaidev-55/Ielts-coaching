          ...
          <div className="fixed inset-0 z-9999 flex items-center justify-center p-5 pointer-events-none">
            ...
            >
              ...
              >
                ...
                <button
                  onClick={onClose}
                  className="absolute cursor-pointer top-4 right-4 z-10 w-10 h-10 rounded-full bg-gray-100 hover:bg-gray-200 flex items-center justify-center transition-colors duration-200 group"
                >
                ...
                {/* Top Badge */}
                <div
                  className="absolute mt-3  left-1/2 -translate-x-1/2 px-6 p-1 rounded-full font-bold text-xs text-white z-10 shadow-lg"
                  style={{
                    background:
